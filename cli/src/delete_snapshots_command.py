  ...
  def cmd(self, args, cli_services):
    ...
    if snapshot_ids:
      ...
      for bp_id in snapshot_ids:
        snapshot = breakpoint_utils.get_breakpoint(firebase_rtdb_service,
                                                   args.debuggee_id, bp_id)
        if snapshot is None:
    ...
    breakpoint_utils.delete_breakpoints(firebase_rtdb_service, args.debuggee_id,
                                        snapshots)
